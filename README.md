...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=96)
...
随着计算机技术的发展以及计算机网络的逐渐普及，互联网成为人们查找信息的重要场所，二十一世纪是信息的时代，所以信息的管理显得特别重要。因此，使用计算机来管理汽车站车辆运管的相关信息成为必然。开发合适的建筑装修图纸管理平台，可以方便管理人员对建筑装修图纸管理平台的管理，提高信息管理工作效率及查询效率，有利于更好的为人们服务。

1.2研究目的

随着互联网技术的快速发展，网络时代的到来，网络信息也将会改变当今社会。各行各业在日常企业经营管理等方面也在慢慢的向规范化和网络化趋势汇合。建筑装修图纸管理平台的信息化程度体现在将互联网与信息技术应用于经营与管理，以现代化工具代替传统手工作业。无疑，使用网络信息化管理使信息管理更先进、更高效、更科学，信息交流更迅速。

对于之前养老系统的管理，大部分都是使用传统的人工方式去管理，这样导致了管理效率低下、出错频率高。而且，时间一长的话，积累下来的数据信息不容易保存，对于查询、更新还有维护会带来不少问题。对于数据交接也存在很大的隐患。如果采用电子化的存储方式就会带来很大的改善，而且给用户的查询带来了很大便利，因此设计一个建筑装修图纸管理平台刻不容缓，能够提高信息的管理水平。
## 1.3系统设计思想
...
# 3系统分析
## 3.1可行性分析
通过对本建筑装修图纸管理平台实行的目的初步调查和分析，提出可行性方案并对其一一进行论证。我们在这里主要从技术可行性、经济可行性、操作可行性等方面进行分析。
### 3.1.1技术可行性
本建筑装修图纸管理平台采用SSM框架，JAVA作为开发语言，是基于WEB平台的B/S架构系统。
...
因此，建筑装修图纸管理平台在开发技术上具有很高可行性，且开发人员掌握了一定的开发技术，所以此系统的开发技术具有可行性。
### 3.1.2经济可行性
本建筑装修图纸管理平台采用的软件都是开源的，这样能够削减很多的精力和资源，降低开发成本。同时对计算机的配置要求也极低，即使是淘汰下来的计算机也能够满足需要，因此，本系统在经济上是完全具有可行性的，所以在经济上是十分可行的。
### 3.1.3操作可行性
本建筑装修图纸管理平台的界面简单易操作，用户只要平时有在用过电脑，都能进行访问和操作。本系统具有易操作、易管理、交互性好的特点，在操作上是非常简单的，因此在操作上具有很高的可行性。

综上所述，此系统开发目标已明确，在技术、经济和操作方面都具有很高的可行性，并且投入少、功能完善、管理方便，因此系统的开发是完全可行的。
## 3.2系统性能分析
### 3.2.1 系统安全性
此建筑装修图纸管理平台要严格控制管理权限，具体要求如下：

（1）要想对建筑装修图纸管理平台进行管理，首先要依靠用户名和密码在系统中登陆，无权限的用户不可以通过任何方式登录系统和对系统的任何信息和数据进行查看，这样可以保证系统的安全可靠性和准确性。
...
建筑装修图纸管理平台需要后台数据库，下面介绍数据库中的各个表的详细信息：
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|tuzhi\_order\_id|int(11)|是|NULL|订单信息|
|yonghu\_id|int(11)|是|NULL|用户id|
|tuzhi\_id|int(11)|是|NULL|图纸id|
|insert\_time|timestamp|是|NULL|接单时间|
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|dingdan\_id|int(11)|是|NULL|订单id|
|shiguongfang\_id|int(11)|是|NULL|施工方id|
|dingdan\_liuyan\_content|text|是|NULL|留言内容|
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|news\_name|varchar(200)|是|NULL|公告名称 Search111|
|news\_types|int(11)|是|NULL|公告类型 Search111|
|news\_photo|varchar(200)|是|NULL|公告图片|
|insert\_time|timestamp|是|NULL|公告时间|
|news\_content|text|是|NULL|公告详情|
|create\_time|timestamp|是|NULL|创建时间 show2 show1 nameShow|
表4. 4设计师
...
|shejishi\_name|varchar(200)|是|NULL|设计师姓名 Search111|
|sex\_types|int(11)|是|NULL|性别|
|shejishi\_id\_number|varchar(200)|是|NULL|身份证号|
|shejishi\_phone|varchar(200)|是|NULL|手机号|
|shejishi\_photo|varchar(200)|是|NULL|照片|
|create\_time|timestamp|是|NULL|创建时间|
表4.5 施工方
...
|username|varchar(200)|是|NULL|账户|
|password|varchar(200)|是|NULL|密码|
|shiguongfang\_name|varchar(200)|是|NULL|施工方姓名 Search111|
|sex\_types|int(11)|是|NULL|性别|
|shiguongfang\_id\_number|varchar(200)|是|NULL|身份证号|
|shiguongfang\_phone|varchar(200)|是|NULL|手机号|
|shiguongfang\_photo|varchar(200)|是|NULL|照片|
|create\_time|timestamp|是|NULL|创建时间|
表4.6 图纸信息
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|tuzhi\_name|varchar(255)|是|NULL|图纸标题 Search111|
|tuzhi\_photo|varchar(255)|是|NULL|图纸预览|
|tuzhi\_file|varchar(255)|是|NULL|文件|
|tuzhi\_types|int(255)|是|NULL|类型 Search111|
|shejishi\_id|int(255)|是|NULL|发布设计师|
|tuzhi\_content|text|是|NULL|详情内容|
|insert\_time|timestamp|是|NULL|发布时间|
|create\_time|timestamp|是|NULL|创建时间 show1 show2 photoShow|
表4. 7图纸收藏
...
|create\_time|timestamp|是|NULL|创建时间 show3 photoShow|
表4. 8图纸留言
...
|tuzhi\_id|int(11)|是|NULL|图纸id|
|yonghu\_id|int(11)|是|NULL|用户id|
|tuzhi\_liuyan\_content|text|是|NULL|留言内容|
|reply\_content|text|是|NULL|回复内容|
|insert\_time|timestamp|是|NULL|讨论时间|
|create\_time|timestamp|是|NULL|创建时间|
表4. 9图纸订单
...
| :-: | :-: | :-: | :-: | :-: |
|id (主键)|int(11)|否||主键|
|order\_number|varchar(255)|是|NULL|订单号|
|tuzhi\_id|int(11)|是|NULL|图纸id|
|yonghu\_id|int(11)|是|NULL|用户id|
|order\_types|int(11)|是|NULL|订单状态 Search111|
|insert\_time|timestamp|是|NULL|下单时间|
|create\_time|timestamp|是|NULL|创建时间 show3|
表4.10 管理员表
...
# 5系统详细实现
## 5.1 设计师管理
建筑装修图纸管理平台的系统管理员可以对设计师信息添加修改删除以及查询操作。具体界面的展示如图5.1所示。

![](/md/blog.009.png)

图5.1 设计师信息管理界面
## 5.2 施工方管理
系统管理员可以查看对施工方信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。
...
图5.3 用户信息管理界面
## 5.4 图纸信息管理
系统管理员可以查看对图纸信息进行添加，修改，删除以及查询操作。具体界面如图5.2所示。

![](/md/blog.012.png)

图5.4 图纸信息管理界面
## 5.5 已接订单管理
系统管理员可以查看已接订单。具体界面如图5.2所示。
